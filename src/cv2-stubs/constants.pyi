...
CMP_LT: Final[int]
CMP_NE: Final[int]
COLORMAP_AUTUMN: Literal[0]
COLORMAP_BONE: Literal[1]
COLORMAP_JET: Literal[2]
COLORMAP_WINTER: Literal[3]
COLORMAP_RAINBOW: Literal[4]
COLORMAP_OCEAN: Literal[5]
COLORMAP_SUMMER: Literal[6]
COLORMAP_SPRING: Literal[7]
COLORMAP_COOL: Literal[8]
COLORMAP_HSV: Literal[9]
COLORMAP_PINK: Literal[10]
COLORMAP_HOT: Literal[11]
COLORMAP_PARULA: Literal[12]
COLORMAP_MAGMA: Literal[13]
COLORMAP_INFERNO: Literal[14]
COLORMAP_PLASMA: Literal[15]
COLORMAP_VIRIDIS: Literal[16]
COLORMAP_CIVIDIS: Literal[17]
COLORMAP_TWILIGHT: Literal[18]
COLORMAP_TWILIGHT_SHIFTED: Literal[19]
COLORMAP_TURBO: Literal[20]
COLORMAP_DEEPGREEN: Literal[21]
